  ...
  <header id="header" class="header fixed-top d-flex align-items-center bg-secondary">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="dashboard.php" class="logo d-flex align-items-center">
        <img src="<?= base_url(''); ?>/assets/img/demografi1.jpg" alt="">
        <span class="d-none d-lg-block">MAHASISWA</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?= base_url(''); ?>/assets/img/mhs2.png" alt="Profile" class="rounded-circle">
